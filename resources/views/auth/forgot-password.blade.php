    ...
    <div class="page-wrapper">
        <div class="auth-container">
            ...
            <div class="auth-tabs" style="border-bottom:none; margin-bottom: 0;">
                <button class="tab-btn active" style="pointer-events: none; padding-bottom: 0;">Reset Password</button>
            </div>

            <div class="auth-body">
                <p style="font-size: 0.85rem; color: var(--text-muted); line-height: 1.5; margin-bottom: 2rem; text-align: center;">
                    Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.
                </p>

                @if (session('status'))
                    <div style="margin-bottom: 1.5rem; color: #2e7d32; font-size: 0.85rem; font-weight: 600; text-align: center; background: #e8f5e9; padding: 0.8rem; border-radius: 8px;">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" class="btn-primary" style="margin-top:0;">Email Password Reset Link</button>

    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Delete Watercourse</h1>
                <div>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-8 col-lg-6">
                    <div class="card border-danger">
                        ...
                        <div class="card-body">
                            <p class="mb-2">Delete Watercourse <strong>{{ $watercourse->name }}</strong> under subCanal {{ $watercourse->subCanal->name }}?</p>
                            <form action="{{ route('watercourses.destroy', $watercourse) }}" method="post" class="d-inline">
                                @csrf
                                @method('DELETE')

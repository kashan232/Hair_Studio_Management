    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Delete Division</h1>
                <div>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-8 col-lg-6">
                    <div class="card border-danger">
                        ...
                        <div class="card-body">
                            <p class="mb-2">Are you sure you want to delete the division <strong>{{ $division->name }}</strong>?</p>
                            @if ($division->sub_divisions_count > 0)
                                <div class="alert alert-warning mb-3">
                                    This division has <strong>{{ $division->sub_divisions_count }}</strong> sub division(s). Because of cascaded deletes, related sub divisions will be removed permanently.
                                </div>
                            @endif

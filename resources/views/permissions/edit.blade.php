    ...
    <div class="side-app">
        <div class="main-container container-fluid py-4">
            ...
            <div class="mb-4">
                ...
                <h1 class="page-title">Modify Permission Details</h1>
            </div>

            <!-- Form Container -->
            <form action="{{ route('permissions.update', $permission->id) }}" method="POST" class="ajaxForm">
                @csrf
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-card">
                            ...
                            <h3 class="form-section-title">Modify Permission Details</h3>
                            
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group-luxury">
                                        <label for="name">Permission Label <span class="text-danger">*</span></label>
                                        <input type="text" name="name" id="name" class="form-control form-control-luxury" placeholder="e.g. Manage Financial Analytics, Edit Client Roster" value="{{ $permission->name }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group-luxury">
                                        ...
                                        <textarea name="description" id="description" class="form-control form-control-luxury" placeholder="Briefly describe what dashboard actions this permission authorizes...">{{ $permission->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 pt-3 border-top border-light d-flex gap-2">
                                ...
                                <a href="{{ route('permissions.index') }}" class="btn-luxury-light">
                                    Cancel & Return
                                </a>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.ajaxForm').submit(function(e) {
            ...
            btn.prop('disabled', true).html('SAVING... <span class="spinner-border spinner-border-sm ms-2"></span>');

    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Delete Sub Division</h1>
                <div>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-8 col-lg-6">
                    <div class="card border-danger">
                        ...
                        <div class="card-body">
                            <p class="mb-2">Are you sure you want to delete the sub division <strong>{{ $subDivision->name }}</strong>?</p>
                            <form action="{{ route('sub-divisions.destroy', $subDivision) }}" method="post" class="d-inline">
                                @csrf
                                @method('DELETE')

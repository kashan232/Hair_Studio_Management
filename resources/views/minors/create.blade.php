    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Create minor</h1>
                <div>
                    <ol class="breadcrumb">
                ...
                <div class="col-md-8 col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0">New minor</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('minors.store') }}" method="post" id="minor-form">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Minors load when you choose a barrage.</small>
                                    @error('minor_id')
...
$(function () {
    ...
    @if (old('barrage_id'))
        loadBranchCanals(@json(old('barrage_id')), @json(old('minor_id')));
    @endif
});
</script>
@endsection

    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Create distributary</h1>
                <div>
                    <ol class="breadcrumb">
                ...
                <div class="col-md-8 col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0">New distributary</h3>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('distributaries.store') }}" method="post" id="distributary-form">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Distributaries load when you choose a barrage.</small>
...
$(function () {
    ...
    @if (old('barrage_id'))
        loadBranchCanals(@json(old('barrage_id')), @json(old('distributary_id')));
    @endif
});
</script>
@endsection

    ...
    <div class="side-app">
        <div class="main-container container-fluid py-4">
            ...
            <div class="mb-4">
                ...
                <h1 class="page-title">Edit User & Role Settings</h1>
            </div>

            <!-- Form Container -->
            <form action="{{ route('users.update', $user->id) }}" method="POST" class="ajaxForm">
                @csrf
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="form-card">
                            ...
                            <h3 class="form-section-title">Modify User Details</h3>
                            
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-luxury">
                                        <label for="name">Full Name <span class="text-danger">*</span></label>
                                        <input type="text" name="name" id="name" class="form-control form-control-luxury" placeholder="e.g. Zain Ahmed" value="{{ $user->name }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-luxury">
                                        <label for="email">Email Address <span class="text-danger">*</span></label>
                                        <input type="email" name="email" id="email" class="form-control form-control-luxury" placeholder="e.g. zain@eladeuk.com" value="{{ $user->email }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-luxury">
                                        ...
                                        <input type="password" name="password" id="password" class="form-control form-control-luxury" placeholder="Enter new password">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-luxury">
                                        <label for="mobile">Mobile Number</label>
                                        <input type="text" name="mobile" id="mobile" class="form-control form-control-luxury" placeholder="e.g. +44 7911 987654" value="{{ $user->mobile }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-luxury">
                                        <label for="role_id">Change System Role <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-luxury">
                                        ...
                                        <input type="text" name="designation" id="designation" class="form-control form-control-luxury" placeholder="e.g. General Manager, Reception Coordinator" value="{{ $user->designation }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group-luxury">
                                        ...
                                        <input type="text" name="cnic" id="cnic" class="form-control form-control-luxury" placeholder="e.g. ID-456-GENERAL" value="{{ $user->cnic }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-luxury">

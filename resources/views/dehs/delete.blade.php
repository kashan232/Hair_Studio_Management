    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            <div class="page-header">
                <h1 class="page-title">Delete DEH</h1>
                <div>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-8 col-lg-6">
                    <div class="card border-danger">
                        ...
                        <div class="card-body">
                            <p class="mb-2">Delete DEH <strong>{{ $deh->name }}</strong> under tehsil {{ $deh->tehsil->name }}?</p>
                            <form action="{{ route('dehs.destroy', $deh) }}" method="post" class="d-inline">
                                @csrf
                                @method('DELETE')

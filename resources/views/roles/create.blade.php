    ...
    <div class="side-app">
        <div class="main-container container-fluid py-4">
            ...
            <div class="mb-4">
                ...
                <h1 class="page-title">Create New System Role</h1>
            </div>

            <!-- Form Container -->
            <form action="{{ route('roles.store') }}" method="POST" class="ajaxForm">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group-luxury">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control form-control-luxury" placeholder="e.g. Booking Coordinator, Junior Stylist" required>
                                    </div>
                                </div>
                            </div>

...
class HairstylistPortalController extends Controller
{
    ...
    public function createPaymentIntent(Request $request): JsonResponse
    {
        ...
        if ($request->has('coupon_code') && $total > 0) {
            ...
            if ($coupon && $coupon->isValidNow() && $coupon->isApplicableTo($bookingType) && !$coupon->hasBeenUsedBy($user, $guestEmail)) {
    ...
    private function isOvernightBooking(): bool
    {
        ...
        // 9 PM (21:00) to 8 AM (08:00): any overlap requires admin approval
